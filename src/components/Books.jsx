...
// Default screen
function Books({ navigation, yourBooks }) {
  const {
  ...
  // Find yourBooks
  const booksToShow = allBooks ? allBooks.filter(item => yourBooks.includes(item.bookId)) : []
    ...
    <View onLayout={onLayout} style={styles.screen}>
      ...
      <Animated.View style={anims.search}>
            <View style={styles.rowItem}>
              <Entypo name={'shopping-cart'} size={24} color={'#52B788'} />
