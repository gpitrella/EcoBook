...
function BookGenre({ genres, title }) {
  const { width, height, margin, colors } = useTheme();
  ...
  return (
    <View style={styles.list}>
      ...
      <AnimatedFlatList
        ...
        data={genres}
        keyExtractor={(i) => genres.indexOf(i)}
        renderItem={({ item, index }) => (
          <Pressable>
            <Genre genre={item} index={index} scrollX={scrollX} />
          </Pressable>
        )}
...
export default React.memo(BookGenre);
